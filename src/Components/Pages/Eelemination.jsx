...
// : 
  ...
  return (
    <div className='absolute top-[100px] left-[-80px]  w-full pb-5'>
    <div className='w-[250px] mx-auto '>  
        <div className="items-center flex pt-5 gap-x-3">
            <div className='w-[100px] h-[100] relative border rounded-full  '>
                <img src={filteredData?.temeLogo} className='rounded-full' />
            ...
            <div>
                ...
                <h1 className="text-center tracking-[2px] font-pop text-white  text-[14px] font-bold">TEAM ELIMINATION</h1>
                <h2 className="font-semibold my-1 w-32 mx-auto text-xl text-center  font-pop text-white">{filteredData?.teamName}</h2>
