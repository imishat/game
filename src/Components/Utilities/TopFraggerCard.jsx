...
const TopFraggerCard = ({player,selectedMatchId}) => {
    ...
    return (
        <div id='animated-background' className='w-11/12 mx-auto px-1 py-3  fragger-card text-black'>
          ...
          <h1 className='text-2xl font-semibold text-white'>Name: {player?.name}  </h1>
          <h1 className='text-2xl font-semibold text-white'>Kills:{player?.kills?.[selectedMatchId]}  </h1>
          </div>
