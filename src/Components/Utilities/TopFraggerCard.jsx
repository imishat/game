        ...
        {player && 
         <div id='' className='w-11/12 mx-auto px-1 py-3 text-black'>
          ...
          <figure className="px-5 pt-5">
            <img src={player?.playerImg} alt="player image" className="rounded-xl h-52 w-full" />
          </figure>
          <div className="card-body items-center text-center">
            <h2 className=" font-bold text-yellow-400 text-2xl h-12  bg-linear-rose  w-full rounded-md text-center"> {player?.name} </h2>
